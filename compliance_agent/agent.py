...
def _fallback_narratives(state: ComplianceState) -> tuple[str, str]:
    ...
    audit_narrative = (
        "Automated fallback narrative generated due to LLM response failure. "
...
Based on the compliance check results below, generate TWO narratives.
...
--- OUTPUT REQUIRED ---
Generate:
1. NARRATIVE: A 5–7 line plain-English summary for the credit officer explaining the compliance result and what action is needed.
2. AUDIT_NARRATIVE: A formal 3–4 sentence regulator-grade narrative citing the specific RBI circulars or regulations relevant to each flag that triggered.
